...
const Testimonials = () => {
  return (
    <section className="w-full flex justify-center items-center bg-[#4C86C4] text-white relative overflow-hidden px-4 md:px-8 py-10 md:py-20">
        <div className="flex w-full max-w-7xl flex-col md:flex-row items-start justify-between gap-6 md:gap-12">
            ...
            <div className="w-full md:w-1/4 flex flex-col gap-3 md:gap-6">
                ...
                <div className='flex flex-row gap-1 md:gap-3 text-white'>
            ...
            <div className="flex flex-col rounded-2xl overflow-hidden shadow-lg">
                {/* Testimonial Text */}
                <div className="bg-[#E0F2FE] text-[#1C4672] p-4 md:p-6 text-center">
                    <p className=''>
                ...
                <div className="bg-[#1C4672] text-white flex flex-row items-center gap-4 p-4 md:p-6">
                    ...
                    <Image
                        src={assets.foot1} alt="Customer 1" fill className="rounded-full object-cover"/>
                    </div>
